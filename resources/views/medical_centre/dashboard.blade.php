...
<head>
    ...
    <title>Medical Centre Dashboard - HealthNet</title>
...
<body>
    ...
    <div class="container py-5">
        <div class="dashboard-header">
            <h1><i class="fas fa-clinic-medical me-2"></i>Medical Centre Dashboard</h1>
            <p class="mb-0">Welcome, {{ Auth::user()->email }}</p>
        </div>
        
        <div class="alert alert-warning">
            <i class="fas fa-clock me-2"></i>
            Your medical centre registration is pending approval. You'll receive an email once verified.
        </div>
