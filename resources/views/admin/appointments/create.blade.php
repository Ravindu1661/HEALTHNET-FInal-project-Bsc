    ...
    <div class="col-lg-10 mx-auto">
        ...
        <div class="dashboard-card">
            <div class="card-header">
                <h6><i class="fas fa-calendar-plus me-2"></i>Appointment Information</h6>
            </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="workplace_type" id="workplace_type" class="form-select" required>
                                ...
                                <option value="medicalcentre" {{ old('workplace_type') == 'medicalcentre' ? 'selected' : '' }}>Medical Centre</option>
                                <option value="private" {{ old('workplace_type') == 'private' ? 'selected' : '' }}>Private Practice</option>
                            </select>
                        ...
                        <div class="col-md-6" id="hospital_field" style="display: none;">
                        ...
                        <div class="col-md-6" id="medicalcentre_field" style="display: none;">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="advance_payment" class="form-control" 
                                   step="0.01" min="0" value="{{ old('advance_payment', 0) }}">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="reason" class="form-control" rows="3" 
                                      placeholder="Brief description of the reason...">{{ old('reason') }}</textarea>
                            @error('reason')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    doctorSelect.addEventListener('change', function() {
        ...
        if (fee) {
            consultationFeeInput.value = fee;
        }
    });
    
    // Show/hide workplace selection based on type
    workplaceTypeSelect.addEventListener('change', function() {
        ...
        // Clear values
        document.getElementById('workplace_id_hospital').value = '';
        document.getElementById('workplace_id_medicalcentre').value = '';
    ...
    if (workplaceTypeSelect.value) {
        workplaceTypeSelect.dispatchEvent(new Event('change'));
    }
